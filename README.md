...
[![Tests: 1577 passed](https://img.shields.io/badge/tests-1577%20passed-brightgreen.svg)](./docs/TESTING_GUIDE.md)
...
The dashboard below is generated by a live full-scale simulation that exercises every major feature area against the real codebase — 18 tracked AI entities, 500 items ingested through the Event-First deduplication pipeline, all four digest delivery modes rendered 20 times each, 30 simulated users with personalised feedback histories, and a 40-thread concurrency stress test — then visualises the resulting statistics in a single artefact.

![Social Media Radar — Full-Scale Mock User Test Dashboard](mock_test_dashboard.png)

| Metric | Result |
|---|---|
| Test suite | **1,577 passed · 0 failed** |
